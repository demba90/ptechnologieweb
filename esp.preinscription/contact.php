	...
	<div class="container">
				<div class="row">
					<div class="col-md-6">
						...
						<p>
						    Ces informations seront utilisées comme éléments de réponses
                        </p>
						...
						<form class="form-light mt-20" role="form">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Phone</label>
										<input type="text" class="form-control" name="phone" placeholder="Number téléphone">
									</div>
								</div>
							</div>
							<div class="form-group">
								<label>Sujet</label>
								<input type="text" class="form-control" name="sujet" placeholder="le sujet que vous voulez parler">
							</div>
							<div class="form-group">
								<label>Message</label>
								<textarea class="form-control" id="message" name="message" placeholder="Votre message ici ..." style="height:100px;"></textarea>
							</div>
							<button type="submit" class="btn btn-two">Envoyer</button><p><br/></p>
						</form>
					</div>
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-6">
								<h3 class="section-title">Adress officielle</h3>
