<?php 
	...
	*/
	...
	public function notification($mailinscrip,$mdpinscrip,$matri, $user_cle){
		...
		Pour terminer l\'activation de votre compte, <a href=\'http://localhost/ptechnologieweb/esp.preinscription/validDossier.php?can='.$matri.'&cle='.$user_cle.'\'>cliquez ici!</a> <br><br> MERCI
		</body></html>';
